...
import id.shobrun.stikieventorganizer.databinding.ItemEventBinding
import id.shobrun.stikieventorganizer.models.entity.Event

class RecyclerEventAdapter (private var items : List<Event>) : RecyclerView.Adapter<RecyclerEventAdapter.EventViewHolder>(){
